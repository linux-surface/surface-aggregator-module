 ...
 * ssam_client_link and ssam_client_bind functions, which are intended to set
 * up device-links for this purpose.
 */
 ...
 * described in its match_flags member.
 */
 ...
 * could be found, returns its driver_data member.
 */
